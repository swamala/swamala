...
const CREATE_INPUT = {
  ...
  tweetAuthorRelation: "exampleTweetAuthorRelation",
  ...
  test("POST /tweets", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        tweetTimestamp: CREATE_RESULT.tweetTimestamp.toISOString(),
      ...
      .expect([
        {
          ...
          tweetTimestamp: FIND_MANY_RESULT[0].tweetTimestamp.toISOString(),
  ...
  test("GET /tweets/:id existing", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        tweetTimestamp: FIND_ONE_RESULT.tweetTimestamp.toISOString(),

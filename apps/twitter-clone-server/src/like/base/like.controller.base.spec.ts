  ...
  test("POST /likes", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        likeCreatedAt: CREATE_RESULT.likeCreatedAt.toISOString(),
      ...
      .expect([
        {
          ...
          likeCreatedAt: FIND_MANY_RESULT[0].likeCreatedAt.toISOString(),
  ...
  test("GET /likes/:id existing", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        likeCreatedAt: FIND_ONE_RESULT.likeCreatedAt.toISOString(),
